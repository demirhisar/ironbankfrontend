                ...
                <div className="row justify-content-center">
                    <div className="col-lg-8 text-center">
                        <div className="section-title">
                            ...
                            <p>
                                The right banking package for you. Get the privilege of choosing between our many Banking Packages,
                                and enjoy services that will reward you and fit your lifestyle.
                            </p>
                        </div>
                    </div>
                </div>
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6">
                        <div className="single-price text-center">
                            ...
                            <ul className="pricing-list">
                                <li>
                                    <Link to={"/services"}>Minimum Deposit $10,00</Link>
                                </li>
                                <li>
                                    <Link to={"/services"}>Minimum Deposit $10</Link>
                                </li>
                                <li>
                                    <Link to={"/services"}>Up to 50 Users avaliable</Link>
                                </li>
                                <li>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-price text-center">
                            ...
                            <ul className="pricing-list">
                                <li>
                                    <Link to={"/services"}>Maximum Deposit $10,00</Link>
                                </li>
                                <li>
                                    <Link to={"/services"}>Minimum Deposit $10</Link>
                                </li>
