                        ...
                        <div className="about-us-details">
                            <div className="section-title">
                                ...
                                <p>
                                    ...
                                    Avoid the queue or delays and try our simple and secure Internet Banking facility for an 
                            ...
                            <div className="media media-2">
                                ...
                                <div className="media-body">
                                    <p>
                                        With E-Banking Check Account Statement, Do Payments using Net Banking, Order Cheque 
                                        Book and many more financial and non-financial services
                                    </p>
                                </div>
                            </div>
                        </div>
